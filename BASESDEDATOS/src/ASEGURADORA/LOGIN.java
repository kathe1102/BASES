...
public class LOGIN extends javax.swing.JFrame {
     Conexiones.ASEGURADORA op=new Conexiones.ASEGURADORA ();
     Connection cnn=op.dbaseguradora();
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(60, 120, 90, 40);
        getContentPane().add(jTextField1);
        jTextField1.setBounds(150, 80, 110, 30);
        getContentPane().add(jPasswordField1);
        jPasswordField1.setBounds(150, 120, 110, 30);
