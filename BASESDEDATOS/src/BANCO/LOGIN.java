...
public class LOGIN extends javax.swing.JFrame {
     Conexiones.BANCODB op=new Conexiones.BANCODB ();
     Connection cnn=op.dbbanco();
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(130, 40, 110, 30);
        getContentPane().add(jPasswordField1);
        jPasswordField1.setBounds(130, 90, 110, 30);
