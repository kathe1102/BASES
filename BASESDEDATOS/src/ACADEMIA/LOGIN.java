...
public class LOGIN extends javax.swing.JFrame {
     Conexiones.ACADEMIADB op=new Conexiones.ACADEMIADB ();
     Connection cnn=op.dbacademia();
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(30, 50, 80, 30);

        jLabel2.setText("CONTRASEÑA");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(20, 90, 90, 40);
        getContentPane().add(jTextField1);
        jTextField1.setBounds(120, 50, 110, 30);
        getContentPane().add(jPasswordField1);
        jPasswordField1.setBounds(120, 90, 110, 30);
